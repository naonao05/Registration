class Math implements Course {
    ...
    Math(String subject, int studentEnrolled,String instructorName,String starttime,String endtime, int studentAllowed)
    {
    ...
    public void isclassfull( ){
        if (this.getStudentEnrolled() < this.getStudentAllowed())
        {
